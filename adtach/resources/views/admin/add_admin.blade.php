            ...
            <div class="row ">
                <div class="col-12   mt-4">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{  route('storeAdminDetail') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-2">
                                        ...
                                        <input type="text" class="form-control" name="user_address" id="exampleInputEmail1"
                                            placeholder="Enter User Address" value="{{ old('user_address') }}">
                                        @error('user_address')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-12 mt-2">
                                        ...
                                        <input type="text" class="form-control" name="user_password" id="exampleInputEmail1"
                                            placeholder="Enter Password" value="{{ old('user_password') }}">
                                        @error('user_password')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-12 mt-2">
                                        ...
                                        <input type="password" class="form-control" name="user_password_confirmation" id="userPasswordConfirmation"
